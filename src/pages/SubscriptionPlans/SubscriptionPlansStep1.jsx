...
//백앤드 연결시 사용 
  ...
  <Header title="맞춤 정보 설정" prevPath="/login" />
        ...
        <div className="subscription-container">
          <h2>맞춤 정보 설정</h2>
          <p>취향에 맞는 제품을 추천해 드릴 수 있도록 맞춤 정보를 입력해주세요.</p>

          {/* 성별 선택 */}
          <div className="section">
            <label className="label">성별</label>
            <div className="gender-group">
              <button className={gender === "여성" ? "selected" : ""} onClick={() => setGender("여성")}>여성</button>
              <button className={gender === "남성" ? "selected" : ""} onClick={() => setGender("남성")}>남성</button>
            </div>
          </div>
